...
class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyEditPageThenGetPageWithVacancy() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        ...
        var expectedVacancy = model.getAttribute("vacancy");

        assertThat(view).isEqualTo("vacancies/one");
        assertThat(expectedVacancy).isEqualTo(vacancy);
    }

    @Test
    public void whenRequestVacancyEditPageThenGetErrorPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenUpdateVacancyThenRedirectToVacanciesPage() {
    ...
    @Test
    public void whenUpdateNotExistsVacancyThenGetErrorPage() {
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
    ...
    @Test
    public void whenDeleteNotExistsVacancyThenGetErrorPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var expectedException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
